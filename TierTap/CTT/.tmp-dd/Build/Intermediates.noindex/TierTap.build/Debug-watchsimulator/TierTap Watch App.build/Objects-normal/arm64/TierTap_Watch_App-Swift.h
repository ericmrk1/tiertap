...
#ifndef TIERTAP_WATCH_APP_SWIFT_H
#define TIERTAP_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TierTap_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17TierTap_Watch_App18SessionSyncManager")
...
@class WCSession;
@class NSString;
@interface SessionSyncManager (SWIFT_EXTENSION(TierTap_Watch_App)) <WCSessionDelegate>
...
SWIFT_CLASS("_TtC17TierTap_Watch_App25WatchNotificationDelegate")
