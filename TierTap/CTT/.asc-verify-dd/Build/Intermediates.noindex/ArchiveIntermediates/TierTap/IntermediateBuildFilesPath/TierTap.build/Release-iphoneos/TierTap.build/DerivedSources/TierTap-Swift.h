...
#ifndef TIERTAP_SWIFT_H
#define TIERTAP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TierTap",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class CLLocation;
SWIFT_CLASS("_TtC7TierTap15LocationManager")
...
SWIFT_CLASS("_TtC7TierTap18SessionSyncManager")
@interface SessionSyncManager : NSObject
...
@class WCSession;
@class NSString;
@interface SessionSyncManager (SWIFT_EXTENSION(TierTap)) <WCSessionDelegate>
...
/// iPhone receives queued action from watch when not reachable for <code>sendMessage</code>.
- (void)session:(WCSession * _Nonnull)session didReceiveUserInfo:(NSDictionary<NSString *, id> * _Nonnull)userInfo;
@end

SWIFT_CLASS("_TtC7TierTap18TierTapAppDelegate")
@interface TierTapAppDelegate : NSObject <UIApplicationDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
