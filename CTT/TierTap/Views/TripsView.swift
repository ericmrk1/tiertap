...
struct TripsView: View {
        ...
        NavigationStack {
            ...
            .overlay(alignment: .bottomTrailing) {
                addTripFloatingButton
                    ...
                    .padding(.bottom, Self.addTripButtonBottomClearance)
            }
    ...
    /// Clears the floating pill tab bar so the + control stays tappable.
    private static let addTripButtonBottomClearance: CGFloat = 82
