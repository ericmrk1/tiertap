...
enum TierTapHomeWidgetPreviewData {
    static let sample = TierTapHomeWidgetSnapshot(
        ...
        tierGoals: [
            .init(id: UUID().uuidString, programName: "MGM Rewards", goalLabel: "NOIR", currentPoints: 82_400, goalPoints: 100_000),
            .init(id: UUID().uuidString, programName: "Caesars", goalLabel: "Diamond", currentPoints: 12_500, goalPoints: 15_000),
            .init(id: UUID().uuidString, programName: "Wynn", goalLabel: nil, currentPoints: 4_200, goalPoints: 10_000)
        ]
    )
}
...
enum TierTapWidgetDeepLink {
    ...
    static let wallet = URL(string: "com.app.tiertap://sessions/wallet")!
